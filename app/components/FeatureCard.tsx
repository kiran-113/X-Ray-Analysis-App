      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-800 rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-gray-300">
            Take a photo or upload an existing image of a X-Ray you want to
            Analyze.
          </p>
        </div>
        <div className="bg-gray-800 rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-gray-300">
            Our advanced AI analyzes the image to Analyze the X-Ray.
          </p>
        </div>
        <div className="bg-gray-800 rounded-lg shadow-md p-6 text-center">
          <div className="bg-green-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-gray-300">
            Receive detailed information about the X-Ray, including its name,
